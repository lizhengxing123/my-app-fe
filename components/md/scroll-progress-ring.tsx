  ...
  return (
    ...
    >
      ...
      >
        ...
        />
        {/* 进度圆环：核心 - Tailwind主题适配（黑/白）+ 原有进度控制 */}
        <circle
          cx={RING_CONFIG.radius}
          cy={RING_CONFIG.radius}
          r={RING_CONFIG.radius - RING_CONFIG.strokeWidth / 2}
          ...
          className="stroke-black dark:stroke-white transition-stroke"
        />
      </svg>
      {/* 进度百分比：同样做主题适配，亮色黑，暗色白 */}
      <span className="absolute text-sm font-medium text-black dark:text-white">
        <ChevronUp />
      </span>
    </div>
  );
