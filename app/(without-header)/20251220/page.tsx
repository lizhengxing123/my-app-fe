  ...
  const init = () => {
    ...
    ScrollTrigger.create({
      ...
      onLeave: () => {
        ...
        const servicesRect = servicesSection.current.getBoundingClientRect();
  ...
  return (
    <main className="page">
      ...
      <nav className="fixed left-0 top-0 w-full p-8 flex items-center justify-between z-10">
        <div className="logo">
          <span className="bg-foreground text-background">大鸺葵观</span>
        </div>
        <div className="menu-btn">
          <span className="bg-background text-foreground">太阳道统</span>
        </div>
      </nav>
      {/* 卡片 */}
